...
const Blogs = () => {
  ...
  return (
    <div style={classes.container}>
      ...
      >
        <Carousel.Item>
          <a style={classes.link} href="https://medium.com/@colebuildanddevelop/screen-scraping-for-real-time-poker-data-25053f572bab" target="_blank">
            <img
        ...
        <Carousel.Item>
          <a style={classes.link} href="https://medium.com/@colebuildanddevelop/i-am-learning-vim-2883fb0565e4" target="_blank">
            <img
              className="d-block w-100 image"
        ...
        <Carousel.Item>
          <a style={classes.link} href="https://medium.com/@colebuildanddevelop/the-flaws-of-communication-e640f9b78420" target="_blank">
            <img
              className="d-block w-100 image"
        ...
        <Carousel.Item>
          <a style={classes.link} href="https://medium.com/swlh/quick-start-node-js-express-mongodb-47465510bd01" target="_blank">
            <img
              className="d-block w-100 image"
